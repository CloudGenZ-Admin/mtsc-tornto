...
export const SiteFooter = () => {
  ...
  return (
    <footer className="bg-navy-dark text-white/90 mt-">
...
>
  ...
  <span className="flex flex-col leading-none justify-center">
    ...
    <span className="text-[12px] md:text-[13px] font-bold uppercase tracking-[0.18em] text-coral-light mt-0.5 whitespace-nowrap">Toronto</span>
        ...
        <div>
          <h4 className="text-sm font-extrabold uppercase tracking-wider text-coral-light mb-4">Explore</h4>
        ...
        <div>
          ...
          <p className="text-sm text-white/70 leading-relaxed">
            Major gifts, corporate partnerships are managed through{" "}
      ...
      <div className="border-t border-white/10">
        <div className="container-page py-5 flex flex-col md:flex-row items-center justify-between gap-2 text-xs text-white/60">
          <p>© {new Date().getFullYear()} Mission to Seafarers Toronto. All rights reserved.</p>
          <p>Toronto station of Mission to Seafarers Southern Ontario · Part of Mission to Seafarers Canada</p>
        </div>
      </div>
    </footer>
  );
