  ...
  <>
    ...
    <section className="py-20 md:py-28 bg-white">
      <div className="container-page max-w-6xl mx-auto">
        ...
        <div className="grid lg:grid-cols-12 gap-12 items-center mb-20 bg-warm-gray p-8 md:p-12 rounded-3xl">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          <div className="flex flex-col items-center text-center bg-white border border-warm-gray rounded-2xl p-8 shadow-card">
            <img src={aliciaImg} alt="Alicia Hamming Navarrete" className="w-40 h-40 object-cover rounded-full shadow-soft mb-6" />
            <h3 className="text-xl font-bold text-navy">Alicia Hamming Navarrete</h3>
            <p className="text-text-mid font-medium mt-2">Program Manager -MTSSO</p>
          </div>
          <div className="flex flex-col items-center text-center bg-white border border-warm-gray rounded-2xl p-8 shadow-card">
            <img src={danImg} alt="Pastor Dan Phannenhour" className="w-40 h-40 object-cover rounded-full shadow-soft mb-6" />
            <h3 className="text-xl font-bold text-navy">Pastor Dan Phannenhour</h3>
            <p className="text-text-mid font-medium mt-2">Hamilton Station Chapalin-</p>
          </div>
        </div>
      </div>
    </section>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-x-6 gap-y-12">
          {boardMembers.map((member, idx) => (
            <div key={idx} className="flex flex-col items-center text-center group">
              <div className="w-32 h-32 md:w-40 md:h-40 mb-5 overflow-hidden rounded-full shadow-soft ring-4 ring-white transition-transform duration-300 group-hover:scale-105">
                <img 
                  src={member.img} 
                  alt={member.name} 
              ...
              <p className="text-sm text-text-mid font-medium mt-1">{member.role}</p>
            </div>
          ))}
        </div>
      </div>
    ...
    <section className="py-20 md:py-28 bg-white">
      <div className="container-page max-w-6xl mx-auto">
        <div className="text-center max-w-3xl mx-auto">
          <span className="eyebrow">How the Structure Works</span>
        ...
        <div className="mt-14 grid md:grid-cols-3 gap-6 relative">
          <div className="rounded-2xl bg-warm-gray p-8 shadow-sm hover:shadow-card-hover transition-all">
            <p className="text-text-mid leading-relaxed">
              <strong className="text-navy block text-lg mb-2">Mission to Seafarers Canada</strong> 
              provides the national foundation, leadership, and support.
            </p>
          </div>
          <div className="rounded-2xl bg-warm-gray p-8 shadow-sm hover:shadow-card-hover transition-all">
            <p className="text-text-mid leading-relaxed">
              <strong className="text-navy block text-lg mb-2">Mission to Seafarers Southern Ontario</strong> 
              guides and supports the ministry across Southern Ontario ports.
            </p>
          </div>
          <div className="rounded-2xl bg-warm-gray p-8 shadow-sm hover:shadow-card-hover transition-all">
            <p className="text-text-mid leading-relaxed">
              <strong className="text-navy block text-lg mb-2">Mission to Seafarers Toronto</strong> 
              brings that mission to life locally at the Port of Toronto.
            </p>
          </div>
        </div>

        <p className="mt-12 max-w-3xl mx-auto text-center text-xl font-bold text-navy leading-relaxed">
      ...
      <div className="container-page">
        <div className="rounded-3xl bg-gradient-hero text-white p-10 md:p-14 text-center relative overflow-hidden">
          ...
          <div className="relative">
            <h2 className="text-3xl md:text-4xl font-extrabold !text-white">Be part of the welcome.</h2>
