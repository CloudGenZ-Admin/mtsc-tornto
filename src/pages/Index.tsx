...
const Index = () => {
  ...
  // Default to showing only the first 3 updates, unless the button is clicked
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-soft aspect-[4/5] sm:aspect-[5/4] lg:aspect-[4/5]">
                ...
                <div className="absolute bottom-0 inset-x-0 p-5 md:p-7">
                  <div className="rounded-xl bg-white/95 backdrop-blur p-4 md:p-5 shadow-card">
                    <p className="text-xs font-bold uppercase tracking-wider text-coral">Toronto Station</p>
          ...
          <div className="container-page mx-auto py-6 grid grid-cols-1 md:grid-cols-3 gap-6 text-center justify-center">
            {[
              ...
              <div key={s.l}>
                ...
                <p className="text-xs md:text-sm mt-1 font-bold uppercase tracking-widest text-text-mid">{s.l}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="container-page">
          ...
          <div className="mt-14 grid md:grid-cols-2 gap-5">
            {[
              ...
              >
                <span className={`grid h-12 w-12 place-items-center rounded-xl ${featured ? "bg-white/20" : "bg-coral-pale"}`}>
                  <Icon className={`h-6 w-6 ${featured ? "text-white" : "text-coral"}`} />
                </span>
                <p className={`mt-5 text-[10px] font-extrabold uppercase tracking-widest ${featured ? "text-white/85" : "text-coral"}`}>
                  {tag}
                </p>
        ...
        <div className="container-page">
          <div className="flex flex-col md:flex-row items-center gap-10 lg:gap-16">
            <div className="flex-1">
              <span className="eyebrow">A Small Service That Makes a Big Difference</span>
              ...
              <p className="mt-3 text-sm text-text-mid leading-relaxed italic">
            ...
            <div className="hidden md:flex w-full md:w-4/12 justify-center">
              <div className="grid h-48 w-48 place-items-center rounded-full bg-white shadow-soft border-4 border-coral/10">
                <Scissors className="h-20 w-20 text-coral" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 md:py-24 bg-warm-gray">
        <div className="container-page">
          <div className="text-center max-w-2xl mx-auto">
            <span className="eyebrow mx-auto">Connected in purpose</span>
            <h2 className="mt-5 text-3xl md:text-4xl lg:text-5xl font-extrabold text-navy leading-tight">
          ...
          <div className="mt-12 text-center max-w-2xl mx-auto">
            <p className="text-sm text-text-mid italic mb-6">
        ...
        <div className="container-page relative z-10">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="rounded-3xl bg-white/95 backdrop-blur p-8 md:p-10 shadow-card hover:shadow-card-hover transition-all border-2 border-coral/15 flex flex-col">
              ...
              <ul className="mt-5 space-y-2 text-sm text-text-mid flex-1">
                <li className="flex gap-2"><HandHeart className="h-4 w-4 text-coral mt-0.5 shrink-0" /> Volunteer at the station or during local events</li>
                <li className="flex gap-2"><HandHeart className="h-4 w-4 text-coral mt-0.5 shrink-0" /> Donate snacks, refreshments, gift cards, furniture, or supplies</li>
                <li className="flex gap-2"><HandHeart className="h-4 w-4 text-coral mt-0.5 shrink-0" /> Support haircut and wellness services for seafarers</li>
                <li className="flex gap-2"><HandHeart className="h-4 w-4 text-coral mt-0.5 shrink-0" /> Help furnish and create a welcoming station space</li>
                <li className="flex gap-2"><HandHeart className="h-4 w-4 text-coral mt-0.5 shrink-0" /> Support a local project or event</li>
                <li className="flex gap-2"><HandHeart className="h-4 w-4 text-coral mt-0.5 shrink-0" /> Become a community or business partner</li>
              </ul>

              <p className="mt-6 mb-4 text-[11px] text-text-mid/80 italic">
              ...
              <Button asChild size="lg" className="w-full bg-coral hover:bg-coral-light text-white font-bold shadow-warm h-12">
                <Link to="/contact">Contact the Toronto Station <ArrowRight className="ml-2 h-4 w-4" /></Link>
              </Button>
            </div>
            ...
            <div className="rounded-3xl bg-gradient-hero text-white p-8 md:p-10 shadow-soft relative overflow-hidden flex flex-col justify-between">
              ...
              <div className="relative flex-1">
                ...
                <ul className="mt-5 space-y-2 text-sm text-white/90 font-medium">
                  <li className="flex gap-2"><ChevronRight className="h-4 w-4 text-coral-light mt-0.5 shrink-0" /> Become a monthly donor</li>
                  <li className="flex gap-2"><ChevronRight className="h-4 w-4 text-coral-light mt-0.5 shrink-0" /> Make a one-time gift</li>
                  <li className="flex gap-2"><ChevronRight className="h-4 w-4 text-coral-light mt-0.5 shrink-0" /> Support Mission to Seafarers Toronto through Mission to Seafarers Canada</li>
                </ul>

                <p className="mt-6 mb-4 text-[11px] text-white/70 italic">
